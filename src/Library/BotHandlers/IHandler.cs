...
/// <summary> Interfaz para implementar el patrón Chain of Responsibility. En ese patrón se pasa un mensaje a través de una
...
/// decidir si el mensaje se procesa o no, y de procesarlo, se realiza en las clases que implementan esta interfaz. <remarks>
...
public interface IHandler {
    ...
    /// <value> <see cref="IHandler"/> que se invoca en caso que el mismo no pueda procesar el mensaje. </value>
    ...
    /// <summary> Retorna este <see cref="IHandler"/> al estado inicial y cancela el próximo si existe. Es utilizado para que los
    /// <see cref="IHandler"/> que procesan varios mensajes cambiando de estado entre mensajes puedan volver al estado inicial en
    /// caso de error por ejemplo. </summary>
    void Cancel();
}
